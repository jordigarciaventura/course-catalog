...
const colorMap: Record<CategoryColor, string> = {
    ...
    violet: "bg-violet-500/10 text-violet-700 border-violet-500/20 dark:bg-violet-400/10 dark:text-violet-300 dark:border-violet-400/20",
    blue: "bg-blue-500/10 text-blue-700 border-blue-500/20 dark:bg-blue-400/10 dark:text-blue-300 dark:border-blue-400/20",
    purple: "bg-purple-500/10 text-purple-700 border-purple-500/20 dark:bg-purple-400/10 dark:text-purple-300 dark:border-purple-400/20",
    orange: "bg-orange-500/10 text-orange-700 border-orange-500/20 dark:bg-orange-400/10 dark:text-orange-300 dark:border-orange-400/20",
    ...
    slate: "bg-slate-500/10 text-slate-700 border-slate-500/20 dark:bg-slate-400/10 dark:text-slate-300 dark:border-slate-400/20",
};
...
export function CategoryBadge({ courseCategory }: Props) {
    ...
    return (
        ...
        >
            {icon && (
                <span
                    className="inline-block mr-2 size-4 [&>svg]:w-full [&>svg]:h-full"
                    aria-hidden="true"
                >
                    {icon}
                </span>
